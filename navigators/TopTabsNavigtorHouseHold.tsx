...
import DashboardHouseholdScreen from '../screens/DashboardHouseholdScreen';
...
export default function TopTabsNavigatorHousehold() {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen name="Dashboard" component={DashboardHouseholdScreen} />
      <Tab.Screen name="DetailsHousehold" component={HouseholdDetailsScreen} />
      <Tab.Screen
